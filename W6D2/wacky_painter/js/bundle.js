...
View.prototype.exercise3 = function() {
  ...
  //your code here!
  const $endHead = $("<h1>It's a duck-blur</h1>");
  $("body").append($endHead);
};
...
View.prototype.exercise4 = function() {
  ...
  //your code here!
  const $everyOther = $(".square:nth-of-type(2n)");
  $everyOther.append("Nick");
};
...
View.prototype.exercise5 = function() {
  ...
  $(".square").on("click", event => {
    ...
    const sqDataPos = $clickedSq.data("pos");
    alert(sqDataPos);
  });
};
...
View.prototype.exercise6 = function() {
  ...
  //your code here!
  const $allTheSquares = $(".square");
  $allTheSquares.each(function(idx, element) {
    $square = $(element);
...
View.prototype.exercise7 = function() {
  ...
  $(".square").on("mouseenter", event => {
    ...
    const sqColor = $element.css("background-color");
    console.log(sqColor);
  });
};
